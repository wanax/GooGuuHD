...
-(void)initComponents{
    ...
    UITabBarItem *barItem=[[[UITabBarItem alloc] initWithTitle:@"港股" image:[UIImage imageNamed:@"emptyStar"] selectedImage:[UIImage imageNamed:@"fullStar"]] autorelease];
    UITabBarItem *barItem2=[[[UITabBarItem alloc] initWithTitle:@"美股" image:[UIImage imageNamed:@"emptyStar"] selectedImage:[UIImage imageNamed:@"fullStar"]] autorelease];
    UITabBarItem *barItem3=[[[UITabBarItem alloc] initWithTitle:@"深市" image:[UIImage imageNamed:@"emptyStar"] selectedImage:[UIImage imageNamed:@"fullStar"]] autorelease];
    UITabBarItem *barItem4=[[[UITabBarItem alloc] initWithTitle:@"沪市" image:[UIImage imageNamed:@"emptyStar"] selectedImage:[UIImage imageNamed:@"fullStar"]] autorelease];
