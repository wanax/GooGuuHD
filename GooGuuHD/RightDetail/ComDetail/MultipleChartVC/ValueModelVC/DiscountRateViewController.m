...
-(void)updateComponents{
    ...
    [self.companyNameLabel setText:[NSString stringWithFormat:@"%@  (%@.%@)",[self.comInfo objectForKey:@"companyname"],[self.comInfo objectForKey:@"stockcode"],[self.comInfo objectForKey:@"market"]]];
