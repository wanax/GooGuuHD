...
-(void)initComponents {
    ...
    [self.getCheckCodeBt setFrame:CGRectMake(170,150,80,40)];
    ...
    KKProgressTimer *tim = [[[KKProgressTimer alloc] initWithFrame:CGRectMake(265,150,40,40)] autorelease];
    self.timer = tim;
    ...
    self.checkCodeField = [self addTextField:@"输入验证码" frame:CGRectMake(40,150,120,40) returnType:UIReturnKeyJoin tag:3 type:UIKeyboardTypeNumberPad isSecure:NO];
...
-(void)cancelBtClicked:(UIButton *)bt {
    [(ClientLoginViewController *)self.parentViewController.parentViewController cancelBtClicked:nil];
}
